...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['user', 'branch', 'permission'], name='permissions_user_id_6b52f0_idx'), models.Index(fields=['role', 'branch', 'permission'], name='permissions_role_313af0_idx'), models.Index(fields=['start_time'], name='permissions_start_t_bea7f2_idx'), models.Index(fields=['end_time'], name='permissions_end_tim_982ee7_idx'), models.Index(fields=['status'], name='permissions_status_d3738f_idx')],
            },
        ),

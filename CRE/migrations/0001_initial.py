    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='branches', to='CRE.company')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branches', models.ManyToManyField(related_name='menus', to='CRE.branch')),
            ],
            options={
                'verbose_name': 'Menu',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('web', 'Website'), ('app', 'Mobile App'), ('pos', 'POS Terminal'), ('kiosk', 'In-Store Kiosk')], default='web', max_length=20, verbose_name='Source')),
                ('table_number', models.CharField(blank=True, max_length=10, null=True)),
                ('status', models.CharField(choices=[('received', 'Received'), ('preparing', 'Preparing'), ('ready', 'Ready to Serve'), ('delivered', 'Delivered'), ('completed', 'Completed'), ('canceled', 'Canceled')], default='Received', max_length=20, verbose_name='Status')),
        ...
        migrations.AddField(
            model_name='menu',
            name='restaurant',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='menus', to='CRE.restaurant'),
        ),
        migrations.AddField(
            model_name='branch',
            name='restaurant',

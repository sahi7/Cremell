    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(decimal_places=2, help_text='Fixed amount for the rule', max_digits=12)),
                ...
                ('priority', models.IntegerField(default=0, help_text='Higher priority rules override lower ones within the same scope')),
